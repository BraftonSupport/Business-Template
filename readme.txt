...
Question me some questions and critique me some critiques! I'll compile a list here.


= How do I do a thing? =

You can change the colors of your site easily using this Theme.

1. In your admin panel, go to Appearance -> Customize.
2. Do the thing!

= How do I add the Social Media Links to the sidebar? =

Widgets!

= How do I add a description for my menu link in navigation? =

This theme sports a menu design that's easy to navigate -- especially when you add menu descriptions.
